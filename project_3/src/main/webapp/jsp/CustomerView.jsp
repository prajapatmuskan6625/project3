		...
		<form action="<%=ORSView.CUSTOMER_CTL%>" method="post">
						...
						<div class="card-body">
							...
							<div class="md-form">
								...
								<div class="col-sm-12">
									...
									<input type="text" name="clientName"onkeydown="return /[a-zA-Z]/i.test(event.key)" maxlength="20" placeholder="Enter clientName"
											oninput="validateAlphaNum(this, 'clientNameError', 25)"
											onblur="validateAlphaNum(this, 'clientNameError', 25)"
											class="form-control"
       	...
       	<span class="pl-sm-5"><b> ContactNumber</b> <span
								...
								<div class="col-sm-12">
									...
									<input type="text" name="contactNumber" maxlength="10"  oninput="validatephone(event)"
						name="phoneNo" maxlength="10" placeholder="Enter contactNumber"
											class="form-control"
