	...
	<div>
		<form class="pb-5" action="<%=ORSView.Employee_LIST_CTL%>" method="post">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="status" placeholder="Enter EmployeeStatus"
						class="form-control"
						value="<%=ServletUtility.getParameter("status", request)%>">
				</div>
				<div class="col-sm-2">
					<input type="text" name="salary" placeholder="Enter EmployeeSalary"
						class="form-control"
			...
			<div style="margin-bottom: 20px;" class="table-responsive">
				<table class="table table-bEmployeeed table-dark table-hover">
					<thead>
						<tr style="background-color: blue;">
							...
							<th width="15%" class="text">EmployeeSalary</th>
